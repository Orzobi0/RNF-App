...
const BottomNav = () => {
  ...
  return (
  <nav
  className="fixed bottom-0 left-0 right-0 z-50 pb-[var(--safe-bottom-clamped)]"
  aria-label="Navegación inferior"
>
  <div className="mx-auto w-full max-w-md h-[var(--bottom-nav-height)] border-fertiliapp-suave bg-white/90 backdrop-blur-md supports-[backdrop-filter]:bg-white/90 rounded-t-3xl shadow-[0_-8px_24px_rgba(244,114,182,0.12)] pt-3.5">
