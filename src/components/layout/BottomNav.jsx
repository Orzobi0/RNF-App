...
const BottomNav = () => {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 border-fertiliapp-suave bg-white/90 backdrop-blur-md supports-[backdrop-filter]:bg-white/90 pt-2 pb-[env(safe-area-inset-bottom)] h-[var(--bottom-nav-safe)]"
    >
